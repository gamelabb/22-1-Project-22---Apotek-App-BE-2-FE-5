                              ...
                              <tbody className='border-0'>
                                 <tr>
                                    <td className="product-thumbnail">
                                       ...
                                       alt=""/></Link></td>
                                    <td className="product-name"><Link to="/shopDetails">Paracetamol</Link></td>
                                 ...
                                 <tr>
                                    <td className="product-thumbnail"><Link to="/shopDetails"><img src="img/shop/img2.jpg"
                                       alt=""/></Link></td>
                                    <td className="product-name"><Link to="/shopDetails">Ibuprofen</Link></td>
                              ...
                              <div className="coupon-all">
                                 <div className="coupon">
                                    <input id="coupon_code" className="input-text" name="coupon_code" defaultValue=""
                                       placeholder="Kode Kupon" type="text"/>
                                    <button className="primary_btn theme-btn-2" name="apply_coupon" type="button">Terapkan kupon</button>
                                 </div>
                                 <div className="coupon2">
                                    <input className="primary_btn theme-btn" name="update_cart" defaultValue="Update Keranjang" type="button"/>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div className="row">
                           <div className="col-md-5 ms-auto">
                              <div className="cart-page-total">
                                 ...
                                 <Link to="/checkout" className="primary_btn theme-btn">Lanjutkan ke pembayaran</Link>
                              </div>
                           </div>
                        </div>
                     </form>
